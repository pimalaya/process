# Process flows [![Documentation](https://img.shields.io/docsrs/process-flows)](https://docs.rs/process-flows/latest/process_flows/) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)
...
*See available flows at [./src/flows](https://github.com/pimalaya/process/tree/master/src/flows).*
...
*See available handlers at [./src/handlers](https://github.com/pimalaya/process/tree/master/src/handlers).*
...
*See complete examples at [./examples](https://github.com/pimalaya/process/blob/master/examples).*
